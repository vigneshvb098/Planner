...
export function DailyTimeline({ tasks, onToggleComplete, onEdit, onDelete }: DailyTimelineProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
      <h2 className="text-gray-900 mb-6">Today's Schedule</h2>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-4 mb-2">
                    <div className="flex-1">
                      <h3 className={`text-gray-900 mb-1 ${task.completed ? 'line-through' : ''}`}>
                        {task.title}
                      </h3>
                      {task.description && (
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <span className={`px-3 py-1 rounded-full border ${categoryColors[task.category]}`}>
                      {task.category}
                    </span>
